              ...
              console.log
                return (
                    <View key={flight.Id} style={styles.station}>
                        ...
                        <Text>{flight.No}, STA: {flight.Scheduled.substring(11,16)}, ETA: {flight.Estimated == null ? "N/A" : flight.Estimated.substring(11,16)}</Text>
                        <Text>{flight.Additional == null ? flight.Status :flight.Additional}, belt {flight.BaggageClaim}</Text>
